...
st.markdown("El archivo debe tener estas columnas: **Año, PIB, Desempleo, TipoCambioPct, Inflación, Ventas**")
...
if uploaded_file:
    ...
    if option == "Ingresar manualmente":
        ...
        forecast["Inflación"] = col4.number_input("Inflación (%)", value=4.80)
